            ...
            <nav className={cn(
                ...
                <div className="container mx-auto px-6 flex justify-between items-center">
                    <div className="flex items-center gap-2 group cursor-pointer" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
                        ...
                        <span className="text-2xl font-black tracking-tighter text-gray-500 uppercase">Senkron</span>
                    </div>
            ...
            <section id="sss" className="bg-slate-900 py-24 relative overflow-hidden scroll-mt-20">
                ...
                <div className="container mx-auto px-6 max-w-4xl relative z-10">
                    <div className="text-center mb-16">
                        <h2 className="text-2xl font-black text-white mb-4 tracking-tighter uppercase opacity-80">Sıkça Sorulan Sorular</h2>
                    </div>

                    <div className="flex flex-col gap-4">
                        {faqs.map((faq, idx) => (
                            <div key={idx} className="bg-white/10 border border-white/10 rounded-none overflow-hidden hover:border-cyan-500/30 transition-colors">
                                <button
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-20">
                        <div className="col-span-1 md:col-span-1">
                            <div className="flex items-center gap-2 mb-6">
                                ...
                                <span className="text-xl font-black tracking-tighter text-gray-500 uppercase">Senkron</span>
                            </div>
