                  ...
                  <div className="flex items-center justify-between">
                     <div className="flex items-center gap-4 min-w-0">
                        ...
                        <div className="min-w-0">
                           <h2 className="text-[13px] font-black text-white uppercase tracking-tighter leading-none truncate">{attendanceTarget.sinif} - {attendanceTarget.ders}</h2>
